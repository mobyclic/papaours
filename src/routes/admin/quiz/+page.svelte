...
<div class="flex-1 p-8 overflow-auto">
  ...
  <div class="mb-8">
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-4xl font-bold bg-gradient-to-r from-amber-400 to-orange-500 bg-clip-text text-transparent">Quiz</h1>
        <p class="text-gray-400 mt-1">Gérez tous les quiz de la plateforme</p>
      </div>
  ...
  <div class="bg-gray-900/50 backdrop-blur-sm rounded-xl shadow-lg border border-gray-800 overflow-hidden">
    ...
    {#if filteredQuizzes.length === 0}
      <div class="px-6 py-12 text-center">
        <p class="text-gray-400 text-sm">Aucun quiz trouvé</p>
      </div>
    {/if}
  </div>
</div>
